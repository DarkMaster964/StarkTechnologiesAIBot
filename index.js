            ...
            <div class="chat">
                ...
                <div class="messageArea" id="messageArea">
                    ...
                    <div class="responseDiv">
                        Dobrodošli na Stark Technologies!
...
lenaCircle.addEventListener("load", async (e) => {
    ...
    if(tid){
        ...
        userInput.value = '';
        const res = await fetch('https://europe-central2-dumbbeapp.cloudfunctions.net/stark_ai_bot/getAllMessages', options);
...
async function sendPrompt() {
    ...
    if (thread_id === null) {
        ...
        const reply = await fetch('https://europe-central2-dumbbeapp.cloudfunctions.net/stark_ai_bot/startThread', options);
        ...
        userInput.value = '';
        const reply = await fetch('https://europe-central2-dumbbeapp.cloudfunctions.net/stark_ai_bot/messageInThread', options);
        const replyData = await reply.json();
